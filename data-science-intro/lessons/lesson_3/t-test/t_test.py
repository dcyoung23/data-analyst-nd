...
def compare_averages(filename):
    ...
    list_1 = baseball_data['avg'][baseball_data.handedness == "R"]
    list_2 = baseball_data['avg'][baseball_data.handedness == "L"]
    #print baseball_data
    #print list_1
    #print list_2

    result = scipy.stats.ttest_ind(list_1,list_2,equal_var=False)
