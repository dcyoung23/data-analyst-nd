...
ggplot(aes(x = carat, y = price), data = diamonds) + 
  ...
  geom_point(alpha = .25, shape = 21, fill = I('#F79420')) +
...
plot1 <- qplot(data = diamonds, x = price, bindwidth = 100, fill = I('#099DD9')) + 
  ggtitle('Price')

plot2 <- qplot(data = diamonds, x = log10(price), binwidth = .01, fill = I('#F79420')) +
  ggtitle('Price (log10)')
